...
const RAW:Raw[]=[
['data-converter','Data & Spreadsheet Converter','Convert mainstream CSV, TSV, JSON, XML, XLSX, ODS, YAML, TOML, and HTML tables locally in one workspace.','csv json xml xlsx yaml toml tsv ods html table converter|spreadsheet converter|data converter|excel converter|openoffice spreadsheet|convert json csv|json to csv|csv to json|csv to excel|excel to csv|csv to xlsx|xlsx to csv|ods to xlsx|xlsx to ods|tsv to csv|csv to tsv|json to ods|ods to json|html table to csv|csv to html|xml to json|json to xml|yaml to json|json to yaml|toml to json|json to toml','table','Data Converter',true],
...
['archive-converter','Archive Converter','Convert ZIP, TAR, and TGZ/TAR.GZ archives between the mainstream supported archive containers locally.','zip to tar|tar to zip|tgz to zip|zip to tgz|tar gz converter|archive converter','archive','Archive Converter'],
];
