...
['flashcard-maker','Flashcard Maker','Create a local flip-through deck from Front :: Back lines.','flashcards|study cards|quiz cards|front back','study','study','',true],
['cloze-deletion-trainer','Cloze Deletion Trainer','Study {{answer}} or {{c1::answer}} blanks with reveal controls.','cloze deletion|fill in blank|active recall','study','study','Cloze Trainer',true],
['memorization-trainer','Memorization Trainer','Hide parts of a passage, type it from memory, and score normalized accuracy.','memorize text|memory practice|recall trainer','study','study','',true],
['self-test-maker','Self-Test Maker','Turn Question :: Answer lines into a reveal-and-score practice session.','self test|practice quiz|question answer|quiz maker','study','study','Self-Test',true],
['spaced-repetition-planner','Spaced Repetition Planner','Calculate a simple next-review interval from current spacing and recall quality.','spaced repetition|review schedule|study interval','study','study','SRS Planner'],
['study-session-planner','Study Session Planner','Split available study time across weighted subjects and planned breaks.','study planner|study schedule|time blocking|subjects','study','study','Study Planner',true],
['reading-plan-divider','Reading Plan Divider','Divide a page range across a chosen number of study days.','reading plan|pages per day|book schedule','study','study','Reading Plan'],
['citation-formatter','Citation Formatter','Build basic APA 7, MLA 9, or Chicago author-date citations from supplied metadata.','apa citation|mla citation|chicago citation|bibliography','citation','study','',true],
];
