...
import { STierBWorkbench } from '../s-tier-b/STierBWorkbench';
import { STierAProConsole } from './STierAProConsole';
...
export const STierARouteWrapper: React.FC<Props> = ({ toolId, Base, initialText }) => {
  ...
  return <>
    ...
    {target ? createPortal(<>
      <STierBWorkbench toolId={toolId} />
      <STierAProConsole toolId={toolId} />
    </>, target) : null}
  </>;
};
