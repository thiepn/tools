...
export const PUBLIC_IMAGE_TASKS: PublicImageTask[] = [
  { id:'crop-image', name:'Crop Image', shortName:'Crop Image', description:'Crop an image to a user-defined rectangle or a common centered aspect ratio entirely in your browser.', keywords:['crop image','photo cropper','trim image','aspect crop'], featured:true },
  ...
  { id:'svg-to-image', name:'SVG to PNG / JPG', shortName:'SVG Converter', description:'Render SVG artwork to a raster PNG, JPEG, or WebP at a chosen size without sending the SVG anywhere.', keywords:['svg to png','svg to jpg','svg rasterizer','convert svg'] },
  ...
  { id:'compress-image-to-size', name:'Compress Image to Target Size', shortName:'Target Size Compress', description:'Aim for a target KB file size with bounded JPEG/WebP quality search at your chosen output dimensions.', keywords:['compress image to 200kb','image target size','reduce photo size','compress jpg kb'], featured:true },
  ...
  { id:'profile-picture-maker', name:'Profile Picture Maker', shortName:'Profile Picture', description:'Create a circular profile-picture PNG from a centered square crop with transparent corners.', keywords:['profile picture','circle crop','avatar maker','pfp crop'], featured:true },
  { id:'blur-pixelate-image', name:'Blur & Pixelate Image', shortName:'Blur / Pixelate', description:'Choose blur or pixelation for an entire image with adjustable strength for quick visual obfuscation.', keywords:['blur image','pixelate photo','mosaic image','blur photo'] },
  { id:'privacy-blur-image', name:'Privacy Blur / Redactor', shortName:'Privacy Blur', description:'Manually blur or pixelate a selected rectangle such as a face, name, screen, address, or license plate.', keywords:['face blur','privacy blur','redact image','blur license plate','hide personal info'], featured:true },
  { id:'image-metadata-cleaner', name:'Image Metadata Viewer & Cleaner', shortName:'Metadata Cleaner', description:'Inspect common JPEG EXIF privacy fields and export a clean re-encoded copy that strips embedded metadata.', keywords:['exif viewer','remove photo metadata','gps metadata','privacy metadata','clean exif'], featured:true },
  ...
  { id:'favicon-maker', name:'Favicon & ICO Maker', shortName:'Favicon Maker', description:'Create a multi-size favicon PNG pack plus a standards-compatible PNG-backed ICO file from one image.', keywords:['favicon maker','png to ico','jpg to ico','website icon','favicon generator'] },
  ...
  { id:'image-border-frame', name:'Add Border / Frame to Image', shortName:'Image Border', description:'Add a solid outside border around an image with configurable width and color.', keywords:['add border to image','photo frame','image outline','white border'] },
  ...
  { id:'image-compare', name:'Image Compare Slider', shortName:'Image Compare', description:'Compare two images with an interactive before/after reveal slider.', keywords:['before after image','compare photos','image slider','visual diff'] },
  ...
  { id:'contact-sheet-maker', name:'Contact Sheet Maker', shortName:'Contact Sheet', description:'Lay multiple images out on a clean thumbnail grid and export one combined PNG sheet.', keywords:['contact sheet','photo sheet','thumbnail sheet','image grid collage'] },
