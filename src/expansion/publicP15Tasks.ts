...
['confidence-interval-calculator','Confidence Interval Calculator','Confidence Interval','Calculate t-based mean intervals or Wilson proportion intervals locally from supplied sample data.','confidence interval|mean interval|proportion interval|wilson','statistics','math'],
['sample-size-calculator','Sample Size Calculator','Sample Size','Estimate sample size locally for a proportion or mean from confidence level and margin-of-error inputs.','sample size|margin of error|survey sample|power planning','statistics','math'],
