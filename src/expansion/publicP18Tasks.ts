...
['perspective-corrector','Perspective Corrector','Straighten photographed artwork, signs, pages, screens, and rectangular objects locally with a four-corner projective warp.','perspective correction|fix perspective|keystone correction|four corner crop|straighten document|warp image','perspective','Perspective',true],
