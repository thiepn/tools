...
['subtitle-converter','Subtitle Converter','Subtitle Converter','Upload or paste SRT, WebVTT, or plain transcript text and convert between compatible subtitle/text formats locally.','subtitle converter|srt vtt|vtt srt|srt text|vtt text|text to subtitles|transcript to srt','subtitle','media'],
