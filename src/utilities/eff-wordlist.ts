// Curated, safe, distinct wordlist of memorable English words for passphrases
export const EFF_WORD_LIST: string[] = [
  'ability', 'able', 'about', 'above', 'accept', 'access', 'across', 'action', 'active', 'actor',
  'adapt', 'adjust', 'admit', 'adopt', 'advance', 'advice', 'afford', 'after', 'again', 'against',
  'agent', 'agree', 'ahead', 'alarm', 'album', 'alert', 'alien', 'align', 'alive', 'allow',
  'almost', 'alone', 'along', 'alpha', 'already', 'alter', 'always', 'amaze', 'amber', 'anchor',
  'ancient', 'angel', 'anger', 'angle', 'animal', 'annual', 'answer', 'antenna', 'apart', 'apology',
  'appear', 'apple', 'apply', 'approve', 'apron', 'arcade', 'arch', 'arctic', 'area', 'arena',
  'argue', 'armor', 'army', 'around', 'arrange', 'arrest', 'arrive', 'arrow', 'artist', 'aspect',
  'assault', 'asset', 'assist', 'assume', 'athlete', 'atlas', 'atom', 'attack', 'attend', 'attitude',
  'attract', 'auction', 'audit', 'august', 'aunt', 'author', 'auto', 'autumn', 'average', 'avocado',
  'avoid', 'awake', 'aware', 'away', 'awesome', 'axis', 'baby', 'bachelor', 'bacon', 'badge',
  'bagel', 'balance', 'balcony', 'ball', 'bamboo', 'banana', 'banner', 'barber', 'barely', 'bargain',
  'barrel', 'base', 'basic', 'basket', 'battery', 'battle', 'beach', 'beacon', 'beam', 'beauty',
  'because', 'become', 'beef', 'before', 'begin', 'behave', 'behind', 'believe', 'below', 'belt',
  'bench', 'benefit', 'berry', 'better', 'beyond', 'bicycle', 'binary', 'biology', 'bird', 'birth',
  'bitter', 'black', 'blade', 'blanket', 'blast', 'blaze', 'blend', 'bless', 'blind', 'block',
  'blonde', 'blood', 'bloom', 'blouse', 'blue', 'board', 'boat', 'body', 'boil', 'bomb',
  'bone', 'bonus', 'book', 'boost', 'border', 'boring', 'borrow', 'boss', 'bottom', 'bounce',
  'boxer', 'bracket', 'brain', 'brand', 'brass', 'brave', 'bread', 'breeze', 'brick', 'bridge',
  'brief', 'bright', 'bring', 'brisk', 'broccoli', 'broken', 'bronze', 'broom', 'brother', 'brown',
  'brush', 'bubble', 'buddy', 'budget', 'buffalo', 'build', 'bulb', 'bulk', 'bullet', 'bundle',
  'bunker', 'burden', 'burger', 'burst', 'bus', 'business', 'busy', 'butter', 'button', 'buyer',
  'cabin', 'cable', 'cactus', 'cage', 'cake', 'calm', 'camera', 'camp', 'canal', 'cancel',
  'candy', 'cannon', 'canoe', 'canvas', 'canyon', 'capable', 'capital', 'captain', 'carbon', 'card',
  'cargo', 'carpet', 'carry', 'cart', 'case', 'cash', 'casino', 'castle', 'casual', 'cat',
  'catalog', 'catch', 'category', 'cattle', 'cause', 'caution', 'cave', 'ceiling', 'celery', 'cement',
  'census', 'century', 'cereal', 'certain', 'chair', 'chalk', 'champion', 'change', 'channel', 'chapter',
  'charge', 'chase', 'chat', 'cheap', 'check', 'cheese', 'chef', 'cherry', 'chest', 'chicken',
  'chief', 'child', 'chimney', 'choice', 'choose', 'chronic', 'chuckle', 'chunk', 'cider', 'cigar',
  'cinema', 'circle', 'citizen', 'city', 'civil', 'claim', 'clamp', 'clap', 'clarify', 'claw',
  'clay', 'clean', 'clerk', 'clever', 'click', 'client', 'cliff', 'climb', 'clinic', 'clip',
  'clock', 'clog', 'close', 'cloth', 'cloud', 'clover', 'club', 'clump', 'cluster', 'clutch',
  'coach', 'coast', 'coconut', 'code', 'coffee', 'coil', 'coin', 'collect', 'color', 'column',
  'combine', 'come', 'comfort', 'comic', 'common', 'company', 'concert', 'conduct', 'confirm', 'connect',
  'consider', 'control', 'convince', 'cook', 'cool', 'copper', 'coral', 'core', 'corn', 'corner',
  ...
  'day', 'deal', 'debate', 'debris', 'decade', 'decide', 'deck', 'decorate', 'decrease', 'deer',
  ...
  'industry', 'infant', 'inflict', 'inform', 'initial', 'inject', 'injury', 'inmate', 'inner', 'innocent',
  ...
  'misery', 'miss', 'mistake', 'mix', 'mixed', 'mixture', 'mobile', 'model', 'modify', 'module',
  ...
  'ride', 'ridge', 'rifle', 'right', 'ring', 'riot', 'ripple', 'risk', 'ritual', 'rival',
  ...
  'tennis', 'tent', 'term', 'test', 'text', 'thank', 'theme', 'theory', 'therapy', 'thing',
  'think', 'thirst', 'this', 'thorn', 'throw', 'thumb', 'thunder', 'ticket', 'tide', 'tiger',
