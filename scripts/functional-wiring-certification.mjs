...
async function makeFixtures(){
  ...
  f.video=path.join(dir,'sample.webm');const videoRun=spawnSync('ffmpeg',['-loglevel','error','-f','lavfi','-i','color=c=blue:s=160x90:d=0.4','-f','lavfi','-i','sine=frequency=440:duration=0.4','-shortest','-c:v','libvpx','-b:v','80k','-c:a','libopus','-b:a','32k','-y',f.video],{stdio:'ignore'});if(videoRun.status!==0)throw new Error('Unable to create WebM fixture');
